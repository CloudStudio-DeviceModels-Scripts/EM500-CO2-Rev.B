...
# Configuration Script – EM500-CO2 - Rev. B

This **Configuration** script is designed for the **EM500-CO2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – EM500-CO2 Rev. B

Este script de **Configuration** está diseñado para el modelo **EM500-CO2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
