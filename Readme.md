...
# Parsing + Configuration Script – EM500-CO2 - Rev. B

This **Parsing + Configuration** script is designed for the **EM500-CO2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EM500-CO2 Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **EM500-CO2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
